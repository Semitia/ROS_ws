...
IMAGE_DIR = "/home/stonewu/图片/"
IMU_CSV_DIR = "/home/stonewu/Data/"
WRENCH_CSV_DIR = "/home/stonewu/Data/"
...
class DataNode(object):
    ...
    def save_latest_data(self):
        ...
        # 打印一些提示信息
        rospy.loginfo("Saved the latest data as %s, %s and %s." % (image_name, imu_name, wrench_name))
